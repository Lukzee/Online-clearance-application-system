...
<body>
    <div class="lgpage">
        ...
        <div style="text-align:center;">
            <h2 style="color:blue;">LIBRARIAN SECTION</h2>
        ...
        <div class="uTable">
            <table  style="width:90%; border:none; margin:auto;" border="1">
                ...
                <tbody>
                    ...
                    $ql="select * from crequest where libreply='$reqst'";
                    ...
                    if(mysqli_num_rows($re) > 0){
                        while($ans = $re->fetch_assoc()){
                            ...
                            <td><form method='post' action='".libReply($conn)."'>
        ...
        if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<script>
                    alert('Welcome to the Librarians section');
                    </script>";
				}
        ?>
