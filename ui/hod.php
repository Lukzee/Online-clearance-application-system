...
<body>
    <div class="lgpage">
        ...
        <div style="text-align:center;">
            <h2 style="color:blue;">HEAD OF DEPARTMENT SECTION</h2>
        ...
        <div class="uTable">
            <table  style="width:90%; border:none; margin:auto;" border="1">
                ...
                <tbody>
                    ...
                    $ql="select * from crequest where hodreply='$reqst' and sDepartment='".$_SESSION['dep']."'";
                    ...
                    if(mysqli_num_rows($re) > 0){
                        while($ans = $re->fetch_assoc()){
                            ...
                            <td><form method='post' action='".hodReply($conn)."'>
        ...
        if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<script>
                    alert('Welcome to the Head of Department section');
                    </script>";
				}
        ?>
