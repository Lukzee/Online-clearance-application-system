...
<body>
    <div class="lgpage">
        ...
        <div style="text-align:center;">
            <h2 style="color:blue;">STUDENTS AFFAIRS OFFICER SECTION</h2>
        ...
        <div class="uTable">
            <table  style="width:90%; border:none; margin:auto;" border="1">
                ...
                <tbody>
                    ...
                    $ql="select * from crequest where saoreply='$reqst'";
                    ...
                    if(mysqli_num_rows($re) > 0){
                        while($ans = $re->fetch_assoc()){
                            ...
                            <td><form method='post' action='".saoReply($conn)."'>
                            
                            <input type='text' name='rId' value='".$ans['rid']."' hidden>
                            
                            <input type='text' name='repAns' value='check' hidden>
                            
                            <button type='submit' name='acpt' style='border:1px solid white;'><i class='fa fa-check'></i></button>
                            </form>
                            </td>
                            
                            <td>
                            <button type='button' style='border:1px solid white;'><i class='fa fa-remove'></i></button>
                            </td>
                            </tr>
                            ";
                        }
        ...
        if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<script>
                    alert('Welcome to the Student Affair Officers section');
                    </script>";
				}
        ?>
